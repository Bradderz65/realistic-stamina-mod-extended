...
public class RStaminaConfig extends Config {
    ...
    @ConfigEntry(comment = "Whether to enable stamina drain while walking. (Default: false)")
    public boolean enableWalkingStaminaDrain = false;
